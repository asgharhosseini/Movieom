...
import kotlinx.android.synthetic.main.item_genre_play.view.*

class GenresPlayAdapter : RecyclerView.Adapter<GenresPlayAdapter.GenreViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GenreViewHolder {
        return GenreViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.item_genre_play, parent, false)
        )
    }
